/**
 * TubePainter with configurable vertex buffer capacity (see three/examples/jsm/misc/TubePainter).
 * Stock TubePainter allocates 1M vertices per mesh (~36MB GPU); use this when rebuilding
 * many strokes from snapshots on low-memory devices.
 */
import {
  BufferAttribute,
  BufferGeometry,
